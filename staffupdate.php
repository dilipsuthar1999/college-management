<html>
	...
	<body>
		...
		<form  name="myForm" action="" method="GET">
			...
			<div class="input-group">
				<br><button type="cancel" name="cancel" value="cancel"><a href="staffdetail.html" style="text-decoration:none; color:white;">Back</a></button>
			</div>
		</form>
	</body>
</html>
...
<?php
	...
	if(!empty($email) && !empty($pho) && !empty($add) && !empty($salary))
	{
		...
		else
		{
			...
			{	
				$sql="UPDATE STAFF SET mobile='$pho',address='$add' ,salary='$salary' where email='$email'";
				if($conn->query($sql))
				{
